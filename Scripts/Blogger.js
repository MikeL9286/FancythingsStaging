(function (Blogger, $, undefined) {
    ...
    Blogger.GetPosts = function (ctrl) {
        ...
        $.ajax({
            ...
            success: function (data) {
                Blogger.blog = data;
                $.each(Blogger.blog.items, function (index, post) {
                    Blogger.posts.push(post);
                });
            }
        });
    };
    ...
    Blogger.ShowMorePosts = function () {
        $.ajax({
            type: "GET",
            url: 'https://www.googleapis.com/blogger/v3/blogs/5073145937869562696/posts?maxResults=5&pageToken=' + Blogger.blog.nextPageToken + '&key=AIzaSyBxl86QJ7gRccq_egFmP3J6Zhy3cQLluIk',
            dataType: "json",
            //async: false,
            processData: "false",
            beforeSend: function (jqXHR, settings) {
    ...
    Blogger.PopulatePostArchive = function () {
